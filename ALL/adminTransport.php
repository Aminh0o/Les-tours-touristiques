  ...
  <body>
    <header class="header">
        ...
        <?php 
         ...
         {
        echo "<a style='text-decoration: none;' href='notif.php?id=".$tuple["ID_ADMIN_TRANSP"]."'><span class='fi-sr-paper-plane'></span></a>";
      }
      else{
        echo "<a style='text-decoration: none;' href='notif.php'><span class='fi-sr-paper-plane'></span></a>";
      }
        ?>
        </div>
    </header>
    ...
    <section  id="notifications" class="notifications">
      <div class="notifications-card">
        ...
        <?php 
          ...
          $id_admin_transp = $tuple["ID_ADMIN_TRANSP"];
          try
          {
            $req = "SELECT * FROM NOTIF WHERE ID_RECEPTEUR='$id_admin_transp' ORDER BY ID_NOTIF DESC ";
