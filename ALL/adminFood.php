    ...
    <header class="header">
        ...
        <div class="sectionDroite">
            ...
            if(isset($_SESSION['loggedIn']) && $_SESSION['loggedIn']==true)
              { 
                echo "<a style='text-decoration: none;' href='notif.php?id=".$tuple["ID_ADMIN_REST"]."'><span class='fi-sr-paper-plane'></span></a>";
              }
            else{
    ...
    <section  id="notifications" class="notifications">
      ...
      <div class="notifications-card">
        ...
        <?php 
          ...
          $id_admin_rest = $tuple["ID_ADMIN_REST"];
          try
          {
            $req = "SELECT * FROM NOTIF WHERE ID_RECEPTEUR='$id_admin_rest' ORDER BY ID_NOTIF DESC ";
