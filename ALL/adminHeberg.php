...
<body>
    <header class="header">
        ...
        {
        echo "<a style='text-decoration: none;' href='notif.php?id=".$tuple["ID_ADMIN_HEBERG"]."'><span class='fi-sr-paper-plane'></span></a>";
      }
      else{
    ...
    ?>
      ...
      <div class="notifications-card">
        ...
        <?php 
          ...
          $id_admin_heberg = $tuple["ID_ADMIN_HEBERG"];
          try
          {
            $req = "SELECT * FROM NOTIF WHERE ID_RECEPTEUR='$id_admin_heberg' ORDER BY ID_NOTIF DESC ";
