<?php
 ...
 if(isset($_SESSION['categorieRoyal']) && isset($_GET['id']) ){
    $categorieRoyal = $_SESSION['categorieRoyal'];
      $numeroPack= $_GET['id'] ;
        try{
            $connexion = new PDO("mysql:host=$server;dbname=$nom_bdd",$user,$password);
            $req = "SELECT * FROM PACK where CATEGORIE='$categorieRoyal' AND NUMEROPACK='$numeroPack' ";
...
<body>
    ...
    <div class="infoGlobal">
        ...
        <?php 
            echo "  <button>
                        <a href='reserverPack.php?wilaya=".$tuple['WILAYA']."&categorie=".$tuple['CATEGORIE']."&type=".$tuple['TYPE_PACK']."'>RESERVE</a>
                    </button>";
        ?>
	</div>
</body>
